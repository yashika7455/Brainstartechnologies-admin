                ...
                <div class="d-flex align-items-end row">
                    <div class="col-sm-7">
                        <div class="card-body">
                            ...
                            <p class="mb-4">
                                You have logined <span class="fw-medium"></span> in your dashboard.
                            </p>

                            <a href="{{ url('admin/profile') }}" class="btn btn-sm btn-outline-primary">View profile</a>
                        </div>
                    </div>
                ...
                <div class="col-lg-6 col-md-12 col-6 mb-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <small class="text-success fw-medium"><i class="bx bx-up-arrow-alt"></i>20</small>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-md-12 col-6 mb-4">
                ...
                <div class="col-6 mb-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <small class="text-danger fw-medium"><i class="bx bx-down-arrow-alt"></i> 50</small>
                        </div>
                    </div>
                </div>
                <div class="col-6 mb-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <span class="fw-medium d-block mb-1">Projects</span>
                            <h3 class="card-title mb-2">Total</h3>
                            <small class="text-success fw-medium"><i class="bx bx-up-arrow-alt"></i> 50</small>
                        </div>
                    </div>
                </div>
                </div>
